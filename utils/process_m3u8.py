...
def download_and_merge_m3u8(m3u8_file_url, download_folder_path, title_of_output_mp4, task_id, progress, portal_name):
...
def merge_segments_into_mp4(m3u8_file_path, download_folder_path, output_file_name, task_id, progress, portal_name):
