...
def download_supplementary_assets(udemy, assets, download_folder_path, course_id, lecture_id, portal_name):
    for asset in assets:
...
def process_files(udemy, asset, course_id, lecture_id, download_folder_path, portal_name):
...
def process_external_links(udemy, asset, course_id, lecture_id, download_folder_path, portal_name):
